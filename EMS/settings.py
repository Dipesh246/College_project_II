...
SECRET_KEY = 'django-insecure-%@9r0^b-o*ke-j5x_(!6@obr99(szw-9*ba+dhcgj9l*5f4ixl'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['52.23.74.123']
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "Stabuy API",
    "DESCRIPTION": "Documentation of API endpoints of Stabuy",
    "VERSION": "1.0.0",
